...
var determine_basal = function determine_basal(glucose_status, currenttemp, iob_data, profile, autosens_data, meal_data, tempBasalFunctions, microBolusAllowed, reservoir_data) {
    ...
    var enableUAM=(profile.enableUAM && ( enableSMB || profile.enableSMB_always ));
    ...
    process.stderr.write("minPredBG: "+minPredBG+" minZTUAMPredBG: "+minZTUAMPredBG+" minIOBPredBG: "+minIOBPredBG+" minZTGuardBG: "+minZTGuardBG);
    if (minCOBPredBG < 999) {
